...
export const Overlay = styled.div`
  background: #daeaf7;
  background: -webkit-linear-gradient(to bottom, #16558F, #0583D2, #4FA5D8, #DAEAF7);
  background: linear-gradient(to bottom, #16558F, #0583D2, #4FA5D8, #DAEAF7);
